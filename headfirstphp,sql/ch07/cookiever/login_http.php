<?php
	...
	if (!isset($_SERVER['PHP_AUTH_USER']) || !isset($_SERVER['PHP_AUTH_PW'])) {
		...
		exit('<h3>Mismatch</h3>Sorry, you must enter your username and password to log in and access this page.
			If you are\'nt a regisetered member, please <a href="signup.php">sign up</a>.');
	}
	...
	if (mysqli_num_rows($data) == 1) {
		...
		header('HTTP/1.1 401 Unauthorized');
		header('WWW-Authenticate: Basic realm = "Mismatch');
		exit('<h2>Mismatch</h2>Sorry, you must enter valid username and password to log in and access this page.
			If you are\'nt a regisetered member, please <a href="signup.php">sign up</a>.');
	}
